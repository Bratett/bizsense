          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
              ...
              >
                <CardContent>
                  <p
                    className={`text-xs font-semibold uppercase tracking-wider ${balanceIsZero ? 'text-green-600' : 'text-amber-600'}`}
                  >
                    Outstanding
                  </p>
                  <p
            ...
            <Card>
              ...
              <CardContent>
                <dl className="divide-y divide-border">
                  {customer.notes && <ProfileRow label="Notes" value={customer.notes} />}
                  ...
                  {customer.momoNumber && (
                    <ProfileRow label="MoMo Number" value={customer.momoNumber} />
                  )}
                  <ProfileRow
                    label="Credit Limit"
            ...
            {/* Deactivate */}
            {customer.isActive && (
              <Button variant="destructive" onClick={() => setShowConfirm(true)} className="h-11">
                Deactivate Customer
              </Button>
            )}
          </div>
