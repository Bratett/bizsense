      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-5">
        ...
        <div className="space-y-5 lg:col-span-3">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
            ...
            {/* Outstanding */}
            <Card className={balance > 0 ? 'border-l-4 border-l-red-500' : 'border-l-4 border-l-green-600'}>
              <CardContent className="p-4">
                <p className={`text-xs font-semibold uppercase tracking-wider ${balance > 0 ? 'text-red-500' : 'text-muted-foreground'}`}>
                  Outstanding
                </p>
                <p className={`mt-1 text-2xl font-bold tabular-nums ${balance > 0 ? 'text-red-600' : 'text-green-700'}`}>
                  {formatGhs(balance)}
                </p>
              </CardContent>
            </Card>
