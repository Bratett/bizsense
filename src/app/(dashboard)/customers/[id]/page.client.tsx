  ...
  return (
    <main className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="mx-auto max-w-5xl">
        ...
        {/* Two-column layout */}
        <div className="grid grid-cols-1 gap-4 md:grid-cols-[300px,1fr]">
          {/* -- Left Sidebar -- */}
              ...
              <CardContent>
                ...
                {creditLimit > 0 && (
                  <>
                    <Separator className="my-4" />
                    <div>
                      <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Credit Utilization</p>
                      <div className="mt-2 flex items-baseline justify-between">
                        <span className="text-base font-bold text-foreground">{formatGhs(balance)}</span>
                        <span className="text-xs text-muted-foreground">of {formatGhs(creditLimit)}</span>
                      </div>
                ...
                <div className="mt-5 space-y-2">
                  <Button render={<Link href={`/orders/new?customerId=${customer.id}`} />} className="h-11 w-full text-sm font-semibold">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
              {/* Outstanding Balance */}
              <Card
                className={balanceIsZero ? 'border-green-200 bg-green-50' : 'border-amber-200 bg-amber-50'}
              >
                <CardContent>
              ...
              <Card>
                <CardContent>
                  ...
                  <p className="mt-1 text-2xl font-bold tabular-nums text-foreground">
                    {creditLimit > 0 ? `${formatGhs(creditLimit)}` : 'None'}
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent>
                  <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Customer Since</p>
            ...
            <Card>
              ...
              <CardContent>
                <dl className="divide-y divide-border">
                  ...
                  <ProfileRow
                    label="Credit Limit"
                    value={creditLimit > 0 ? `${formatGhs(creditLimit)}` : 'None'}
                  />
                </dl>
              </CardContent>
            </Card>
