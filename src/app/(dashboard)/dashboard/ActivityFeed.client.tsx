...
function SaleIcon() {
  return (
    <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-green-50">
      <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="#00704A" strokeWidth={1.5}>
...
function ExpenseIcon() {
  return (
    <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-red-50">
      <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="#D93025" strokeWidth={1.5}>
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-gray-500">
                  {item.type === 'sale' ? 'Sale' : item.status === 'pending_approval' ? 'Expense' : 'Expense'}
                  {' \u00b7 '}
