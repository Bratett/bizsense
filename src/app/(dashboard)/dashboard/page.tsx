...
export default async function DashboardPage() {
  ...
  const [legacy, todaySales, cashBalance, receivables, payables, pendingApprovals, activity, chartData, lowStock] =
    await Promise.all([
        ...
        <div className="flex flex-col gap-6 md:flex-row">
            ...
            <div className="space-y-2">
                ...
                >
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-red-800">
                      {receivables.count} unpaid {receivables.count === 1 ? 'invoice' : 'invoices'} &middot; GHS {formatGHS(receivables.total)}
                    </p>
                  </div>
                  <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} className="text-red-500">
              ...
              {lowStock.count > 0 && (
                ...
                >
                  ...
                  <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} className="text-amber-500">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                  </svg>
                </Link>
              )}
                ...
                >
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-yellow-800">
                      {pendingApprovals.count} {pendingApprovals.count === 1 ? 'expense' : 'expenses'} awaiting approval
                    </p>
                  </div>
                  <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} className="text-yellow-600">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                  </svg>
                </Link>
              )}
          ...
          <div className="md:w-[400px] space-y-6">
            ...
            <div className="text-center pb-4">
              <Link href="/ledger" className="text-sm font-medium text-green-700 hover:text-green-800">
