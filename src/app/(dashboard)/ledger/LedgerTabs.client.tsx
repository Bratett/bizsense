                ...
                <tr>
                  ...
                  >
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <p className="text-sm font-semibold text-gray-700">No journal entries found</p>
                ...
                <tr>
                  <td colSpan={6} className="px-3 py-12 text-center">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <p className="text-sm font-semibold text-gray-700">No transactions in this period</p>
                      <p className="text-sm text-gray-500">Select a different date range to view the trial balance.</p>
                    </div>
                  </td>
                </tr>
              )}
