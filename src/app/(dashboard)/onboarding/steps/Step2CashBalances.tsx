  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Enter what you have right now. You can update this later.</CardDescription>
      </CardHeader>
      <CardContent>
        {error && (
        ...
        <div className="mt-5 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <p className="text-xs text-muted-foreground">
              This becomes your BizSense start date. Transactions before this date stay in your
              paper records.
            </p>
          </div>
