      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.detailRow}>
          <View style={styles.detailBlock}>
            ...
            {data.supplier.phone && <Text style={styles.detailValue}>{data.supplier.phone}</Text>}
        ...
        <View>
          ...
          {data.rows.map((row, i) => (
            <View key={i} style={styles.tableRow}>
              ...
              <Text style={[styles.tableCell, styles.colBalance]}>{formatGHS(row.balance)}</Text>
            </View>
          ))}
        </View>
        ...
        <View style={styles.footer}>
          <View style={styles.footerBalanceRow}>
            <Text style={styles.footerBalanceLabel}>Outstanding Balance as at {data.asAt}:</Text>
            <Text style={styles.footerBalanceValue}>GHS {formatGHS(data.outstandingBalance)}</Text>
          </View>
          <Text style={styles.footerNote}>
            This statement was generated by {data.business.name}. Please contact us if you have any
            queries.
          </Text>
        </View>
      </Page>
